        ...
        for operacao in lista_operacoes:
            for indice, caractere in enumerate(expressao[inicio_parenteses:fim_parenteses]):
                if caractere == operacao:
                    ...
                    if operacao == '^':
                        display_message(self.aid.localname, 'Expressão atual: {}'.format(expressao))
                        display_message(self.aid.localname, 'Enviando a expressão para o Agente de Exponenciação...\n')
                    ...
                    #Se for raiz
                        ...
                        display_message(self.aid.localname, 'Expressão atual: {}'.format(expressao))
                        display_message(self.aid.localname, 'Enviando a expressão para o Agente de Raiz Quadrada...\n')
                    ...
                    #Se for multiplicação
                        ...
                        display_message(self.aid.localname, 'Expressão atual: {}'.format(expressao))
                        display_message(self.aid.localname, 'Enviando a expressão para o Agente de Multiplicação...\n')
                    ...
                    #Se for divisão
                        ...
                        display_message(self.aid.localname, 'Expressão atual: {}'.format(expressao))
                        display_message(self.aid.localname, 'Enviando a expressão para o Agente de Divisão...\n')
                    ...
                    #Se for adição
                        ...
                        display_message(self.aid.localname, 'Expressão atual: {}'.format(expressao))
                        display_message(self.aid.localname, 'Enviando a expressão para o Agente de Adição...\n')
                    ...
                    #Se for subtração
                        ...
                        display_message(self.aid.localname, 'Expressão atual: {}'.format(expressao))
                        display_message(self.aid.localname, 'Enviando a expressão para o Agente de Subtração...\n')
